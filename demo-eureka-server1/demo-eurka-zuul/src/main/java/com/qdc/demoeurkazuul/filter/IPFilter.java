package com.qdc.demoeurkazuul.filter;
...
public class IPFilter extends ZuulFilter {
    ...
    public Object run() throws ZuulException{
        ...
        System.out.println("请求IP为 : [ " + ipAddr + "]");
        List<String> ips = ips = new ArrayList<>();
...
//        if (!ips.contains(ipAddr)){
        if (ips.contains(ipAddr)){
            ...
            ctx.setResponseBody("{\"errrocaode\":\"00001\",\"errmsg\":\"IpAddr is forbidden![" + ipAddr + "]\"}");
        }
        return null;
    }
